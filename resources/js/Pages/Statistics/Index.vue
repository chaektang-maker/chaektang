...
<template>
    <Head>
        ...
        <meta name="description" content="สถิติหวยย้อนหลัง สถิติเลขออกบ่อย 2 ตัว 3 ตัว เลขวิ่ง หวยเลขเด็ด วิเคราะห์ข้อมูลหวยย้อนหลังหลายปี" />
        <meta name="keywords" content="สถิติหวย, สถิติเลขออกบ่อย, สถิติหวยย้อนหลัง, หวยเลขเด็ด, เลขออกบ่อย, วิเคราะห์หวย" />
        <meta property="og:title" content="สถิติหวยย้อนหลัง - แจกตัง" />
        <meta property="og:description" content="สถิติหวยย้อนหลัง สถิติเลขออกบ่อย 2 ตัว 3 ตัว เลขวิ่ง หวยเลขเด็ด" />
        <meta name="twitter:title" content="สถิติหวยย้อนหลัง - แจกตัง" />
        <meta name="twitter:description" content="สถิติหวยย้อนหลัง สถิติเลขออกบ่อย 2 ตัว 3 ตัว เลขวิ่ง หวยเลขเด็ด" />
    </Head>
